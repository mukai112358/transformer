...
- Transformer をスクラッチで実装。Scaled Dot-Product Attention / Multi-Head Attention / Position-wise FFN / Positional Encoding / Encoder / Decoder の各モジュールを src/ 配下に分割
...
- BLEU と文長別精度を計算する評価コードを src/evaluate.py に。Greedy Decode の実装込み

## 触った PyTorch

- nn.Module の継承と forward の書き方
- nn.Linear / nn.LayerNorm / nn.Embedding / nn.LSTM / nn.Dropout / nn.ModuleList
- テンソル操作: transpose, view, reshape, matmul / @, masked_fill, contiguous
